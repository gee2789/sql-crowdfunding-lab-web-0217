...
"SELECT projects.title, (SUM(pledges.amount)-projects.funding_goal) AS valid_funding FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING valid_funding >= 0;"
end
